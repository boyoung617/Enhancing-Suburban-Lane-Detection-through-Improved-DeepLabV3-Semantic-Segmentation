...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    #video_path      = 0
    video_path = r"C:\Users\Administrator\Desktop\deeplab2 - test\img\13.mp4"
    video_save_path = r"C:\Users\Administrator\Desktop\deeplab2 - test\img"
    video_fps       = 30.0
    #----------------------------------------------------------------------------------------------------------#

...
class DeeplabV3(object):
    _defaults = {
        ...
        #-------------------------------\\------------------------------------#
        "model_path"        : 'logs/test_best_weights.pth',
        #"model_path": 'logs/ep010-loss0.119-val_loss0.094.pth',
        #"model_path": 'logs_test\\improved deeplab mobilenet\\logs_4_8_32_cbam_360x360\\ep005-loss0.152-val_loss0.089.pth',
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 2,
